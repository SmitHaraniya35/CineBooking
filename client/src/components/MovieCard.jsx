...
//   return (
//     <div className="group relative bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden h-auto">
//       {/* Movie Poster - Fixed Height Container */}
...
//           <Link
//             to={`/movies/${movie._id}`}
//             className="flex-1 px-3 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors text-center font-medium text-sm"
//           >
//             View Details
//           </Link>
//           {user && user.role == "admin" && (<button
//             onClick={handleBookNow}
//             className="flex-1 px-3 py-2 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg hover:from-red-700 hover:to-red-800 transition-all transform hover:scale-105 font-medium text-sm shadow-lg"
//           >
//             View Shows
//           </button>)}
//           {user && user.role != "admin" && (<button
